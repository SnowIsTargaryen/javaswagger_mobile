     	...
     	<div class="col-sm-8 main-section">
            ...
            <form class="col-12"  action="login" method="post">
					<div class="form-group" id="userid">
						<input type="text" id="user_ID" name="user_ID" class="form-control" placeholder="Enter ID" required autofocus>	
					</div>  			
					...
					<div class="col-12 forgot">
						<a href="#" id="btnAccount">sign-up</a><br>
						<a href="#" id="findId">Forgot Password?</a>
					</div>
