                ...
                <div class="card-body">
                    ...
                    <form class="form-signin" action="findUserPwd" method="post">
                        <div class="form-label-group">
                            <input type="text" id="user_id" name="user_id" class="form-control" placeholder="ID입력"
                                   required autofocus>
                            <label for="inputEmail">ID</label>
                        </div>
                        <div class="form-label-group">
                            <input type="text" id="user_email" name=user_email class="form-control"
                                   placeholder="가입시 등록한  e-mail입력" required>
                        ...
                        <button class="btn btn-lg btn-primary btn-block text-uppercase" id="announce" type="submit">
                            Password 찾기
                        </button>
