            ...
            <form action="../account/create" id="userInfo" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="user_Email" name="user_Email"
                           placeholder="email을 입력하세요" oninput="checkMail()" required="required">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="user_Phone" name="user_Phone" oninput="checkPhone()"
                           placeholder="핸드폰 번호 입력 (-없이 입력해주세요!)" required="required">
...
<!-- 메일인증 Modal -->
<div class="modal fade " id="checkEmil" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
...
<!-- phone인증 Modal -->
<div class="modal fade " id="checkPhone" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- <form class="form"  action="confirm.do" method="post">  -->
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input class="form-control" type="number" id="inputPhone" name="inputPhone"
