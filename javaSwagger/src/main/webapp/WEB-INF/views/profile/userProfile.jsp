        ...
        $(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //게시글 리스트
                    $.ajax({
                        url: "../board/listPost?user_ID=<%=get_id%>",
                        success: function (data) {
...
<!--   Header 사용자 프로필 -->
<div class="py-5 bg-image-full text-white text-center" style="background-image: url('../resources/image/rain.gif');"
     id="profileHeader">
    <img class="img-fluid d-block mx-auto rounded-circle" src="../resources/image/${profile.user_fname }"
         id="profileImg">
    <div class="btn-group" role="group">
        <button type="button" class="btn btn-sm btn-outline-secondary border-0 text-white" data-toggle="modal"
                data-target="#followerList_Modal" id="a_Follower_List">팔로워
        </button>
        <button type="button" class="btn btn-sm btn-outline-secondary border-0 text-white" data-toggle="modal"
                data-target="#followingList_Modal" id="a_Following_List">팔로잉
        </button>
        <button type="button" class="btn btn-sm btn-outline-secondary border-0 text-white" id="b_follow"><img
                id="a_Follow" src="../resources/icon/follow24w.png"></button>
