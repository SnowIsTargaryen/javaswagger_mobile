...
<nav class="nav navbar navbar-expand-sm navbar-light bg-light">
    <div class="navbar-header navbar-center mx-2">
        <a class="navbar-brand mb-0 h1 mx-3 my-2 " href="#">회원 탈퇴</a>
    </div>
    ...
    <div class="row justify-content-center mx-auto">
        <div class="col justify-content-center mx-auto">
            <div class="tab-content">
                ...
                <div class="tab-pane container fade" id="editProfile">
                    <form action="../profile/settingPassword" method="post" enctype="multipart/form-data">
                        <div class="form-group col-md-7 ">
                            <img id="proPhoto" data-target="#updatePost" style="display: none;"
                                 src="../resources/image/${profile.user_fname }">

                            <input type="hidden" class="form-control" id="user_ID" name="user_ID"
                                   value="${profile.user_ID }">
                            <input type="hidden" class="form-control" id="user_Password" name="user_Password"
                                   value="${profile.user_Password}">
                            <input type="hidden" class="form-control" id="user_fname" name="user_fname"
                        ...
                        <div class="form-group .col-3 col-sm-8 col-md-8  col-lg-5">
                            ...
                            <input type="tel" class="form-control" id="user_Phone" name="user_Phone"
                                   placeholder="변경 할 번호 입력">
                        </div>
                        <button type="submit" class="btn btn-success .col-3 col-sm-8 col-md-8  col-lg-5">회원정보 변경
                        </button>
                    </form>
                </div>
                <!-- 비밀번호 변경  -->
                ...
                <!-- 회원탈퇴  -->
                <div class="tab-pane container active" id="dropUser">
                    <form action="../profile/settingWithdrawUser" method="post">
                        <div class="form-group col-md-7">
                            <label for="user_ID">아이디</label>
                            <input type="text" class="form-control" id="user_ID" name="user_ID"
                                   placeholder="탈퇴 할 아이디를 입력하세요">
                        </div>
                        <div class="form-group col-md-7">
                            <label for="user_Password ">암호</label>
                            <input type="password" class="form-control" id="user_Password" name="user_Password"
