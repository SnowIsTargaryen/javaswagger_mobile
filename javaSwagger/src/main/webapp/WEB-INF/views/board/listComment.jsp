        ...
        $(function () {
            ...
            $.ajax({ //게시글 상세
                ...
                success: function (data) {
                    ...
                    if (p.user_fname == null) {
                        $("#postImage").attr({src: "../resources/icon/user2.png"});
                    }
            ...
            $.ajax({ //댓글 리스트
                ...
                success: function (data) {
                    ...
                    $.each(arr, function (i, p) {
                        ...
                        if (p.user_fname == null) {
                            $(img_comment).attr({src: "../resources/icon/user2.png"})
                        }
        ...
        <div class="col col-md-6">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <button type="button" class="btn flot-right btn-sm btn-outline-secondary border-0" id="back"><img
                            src="../resources/icon/left-arrow.png"></button>
